...
#contant ul li{ float:left; display:block; margin:35px; }
...
img{width:60px;
	...
	transition-duration:1s,1s,1s,1s,1s,1s; margin:15px;}
...
.bigImg{-moz-transform: rotate(360deg);
    ...
    background:#1ec7e6;
	width:290px; left:30%;
	height:360px; position:absolute; z-index:9999;}
</style>
</head>
...
<div id="contant">
<ul>
<c:forEach var="item" begin="1" end="200" step="1" varStatus="s">
	<li><img id="head${item}"  class="minImg "  src="${ctx}/images/star.jpg"/></li>
</c:forEach>
</ul></div>
</body>
