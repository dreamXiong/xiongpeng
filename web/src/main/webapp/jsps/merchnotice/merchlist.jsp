...
<c:set value="merchNotice" var="modalName"></c:set>
<body>
	<!-- 内容板块开始 -->
	<div class="cantainer">
		<div class="area news">
			<form action="queryMerchNotices" name="noticeForm" id="key_${modalName}_qryFrm" class="form-horizontal" method="post">
			</form>
			<div class="news-left pull-left ">
				<h4 class="bg-gray">招商公告</h4>
				<div class="border-gray">
					<h5 class="line-height">
						标题 <span class="pull-right">发表时间</span>
					</h5>
					<div id="key_${modalName}_list" style="padding-bottom:10px;">					
						<%@include file="merchlistPage.jsp"%>	            
					</div>					
				</div>
			</div>
		</div>
