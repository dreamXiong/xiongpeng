...
public class TbAdminPermission implements Serializable {
     ...
     * 子菜单
     */
    private List<TbAdminPermission> childs = new CopyOnWriteArrayList<TbAdminPermission>();
    ...
    public List<TbAdminPermission> getChilds() {
        return childs;
    }
     ...
     * @param child 子菜单
     */
    public void addChild(TbAdminPermission child) {
        lock.lock();
        try {
