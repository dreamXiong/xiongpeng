 ...
 *
 * @author 王丹
 * @FileName CustomSendExecuteService.java<br>
 * @Language Java<br>
 * @date 2016-01-11<br>
 */
@Service("customSendExecuteService")
public class CustomSendExecuteService extends WeChatPostDataExecuteService {

    @Override
    protected String queryRequestUrl() throws WapServiceException {
        return HglContants.WE_CHAT_CUSTOM_SEND + String.format(HglContants.WE_CHAT_ACCESS_TOKEN_PARAM, tokenService.getToken());
    }
