 ...
 *
 * @author 王丹
 * @FileName MenuDelconditionalExecuteService.java<br>
 * @Language Java<br>
 * @date 2016-01-08<br>
 */
@Service("menuDelconditionalExecuteService")
public class MenuDelconditionalExecuteService extends WeChatPostDataExecuteService {

    @Override
    protected String queryRequestUrl() throws WapServiceException {
        return HglContants.WE_CHAT_MENU_DELCONDITIONAL + String.format(HglContants.WE_CHAT_ACCESS_TOKEN_PARAM, tokenService.getToken());
    }
