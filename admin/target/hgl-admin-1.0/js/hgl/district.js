...
function countryChange(){
	var countryCode=$("#countryCode").val();
	  	...
	  	$.ajax({
		  		url: ctx+'/merchants/streetInfos?cid='+countryCode,
 ...
 function cityChange(){
	 var cityCode = $("#cityCode").val();
 	  	$.ajax({
		  		url: ctx+'/merchants/countryInfos?cid='+cityCode,
		  		success : function(data) {
					var selectHtml = "<option value='0'>请选择&nbsp;&nbsp;</option>";
					var countryCode=$("#countryCode").val();
 ...
 function gradeChange(){
	 ...
	 var cityCode = $("#cityCode").val();
	  	$.ajax({
		  		url: ctx+'/merchants/cityInfos?pid='+opt,
		  		success : function(data) {
					var selectHtml = "<option value='0'>请选择&nbsp;&nbsp;</option>";
...
//获取地市信息
 function getCitys(province){
  	...
  	$.ajax({ 
         type:"POST",
         url:ctx+'/merchants/cityInfos?pid='+province,
 ...
 function getCountrys(cityCode){
	//发送请求获取地市信息
	 var city=cityCode;
  	$.ajax({
         type:"POST",
         url: ctx+'/merchants/countryInfos?cid='+city,
         data:"cityCode=" + city,
         success:function(data){
         	var selectHtml = "<option value='0'>-请选择-</option>";
         	var countryCode ="";
 ...
 function getStreet(countryCode){
		 ...
		 var country=countryCode;
	  	$.ajax({
	         type:"POST",
	         url: ctx+'/merchants/streetInfos?cid='+country,
