...
<tiles:insert beanName="indexPage">
	<tiles:put name="title" value="配置管理" />
...
<body >
<c:set value="systemConfig" var="modalName"></c:set>
             ...
             <form id="key_${modalName}_qryFrm" class="form-horizontal">
              <div  class="col-sm-4">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="name" id="name" class="form-control" placeholder="请输入查询名称/值/描述">
                  </div>
                </div>
              </div>
              <div class="col-sm-4 ">
              ...
              <div class="col-sm-12">
                <div id="key_${modalName}_list">
               		<%@include file="systemConfigList.jsp"%>
               </div>
              </div>
    		</div>
    		</div>
...
<!-- 二级类弹出框  deleteSecond-->
<div class="modal fade" id="deleteSystemConfig">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-footer" style="text-align:center!important;" >
        ...
        <button type="button" class="btn btn-primary btn-sm" onclick='goDeleteSystemConfig()'>确定</button>
      </div>
    </div>
  </div>
</div>
