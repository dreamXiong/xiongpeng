...
<tiles:put name="title" value="积分商城类型修改" />
<tiles:put name="body" type="String">
<html lang="en">
<head>
	<meta charset="UTF-8">
	<title>积分商城类型修改</title>
	<!--文件上传 -->
    		...
    		<div class="box box-primary">
    			<div class="box-body">
		             <form action="${ctx }/integralMallType/updateIntegralMallType" id="updateIntegralMallType" method="post" class="form-horizontal">
		              <input name="id" type="hidden" id="id" value="${integralMallType.id }">       
		              <input name="goodsTypeImage" type="hidden" id="goodsTypeImage" value="${integralMallType.goodsTypeImage }">
		              <div class="form-group">
		                <label  class="col-sm-2 control-label">商品类型名称</label>
		                <div class="col-sm-8">
		                  <input type="text" id="goodsTypeName" class="form-control inputNotNull" maxlength="50" name="goodsTypeName" value="${integralMallType.goodsTypeName }"/>
		                </div>
		              </div> 
		             <div class="form-group"> 
		                ...
		                <div class="col-sm-8" style="display:inline">
		                 <div class="input-group" id="imgErrorDiv">   
		                    <input type="text"  class="form-control" id="input1" value="${integralMallType.goodsTypeImage }">
		                  ...
		                  <div id="goodsImageDiv" style="border:1px solid #d2d6de;margin-top:5px ">     
		                    <img id="goodsImageShow" src="${ctx}/integralMallType/generateImage?imgName=${integralMallType.goodsTypeImage }">
		                    <span style="width:500px">建议传200*240px的图片，必须是.gif,jpeg,jpg,png格式且不大于5MB。</span>
		                  </div>
		              	</div>
		              </div>
		              <div class="form-group">
		                ...
		                <div class="col-sm-8">
		                  <textarea type="text" id="goodsTypeDescribe" class="form-control inputNotNull" maxlength="500" name="goodsTypeDescribe" rows="2" >${integralMallType.goodsTypeDescribe }</textarea>
		                </div>
		              </div>  
		              <div class="row">
		                <div class="col-sm-6 text-right">
		                  <button type="button" onclick="updateIntegralMallType();" class="btn btn-primary">确定</button>
		                </div>
