...
<tiles:put name="title" value="积分商城添加" />
    ...
    <section class="content">
    	<div class="row no-margin">       
    		<div class="box box-primary">
    			<div class="box-body">
		             <form action="${ctx }/integralMall/insertIntegralMall" id="saveIntegralMall" method="post" class="form-horizontal">
		              <input name="goodsImage" type="hidden" id="goodsImage">
		              ...
		              <div class="form-group">
		                ...
		                <div class="col-sm-8">
		                  <input type="text" id="goodsName" class="form-control inputNotNull" maxlength="50" name="goodsName" />
		                </div>
		              </div> 
		              <div class="form-group">
		                <label  class="col-sm-2 control-label">积分</label>
		                <div class="col-sm-8">
		                  <input type="text" id="integral" class="form-control inputNotNull" maxlength="10" name="integral" /><span style="color: red;" id="integralError"></span>
		                </div>
		              </div> 
		              <div class="form-group">
		                <label  class="col-sm-2 control-label">需支付金额</label>
		                <div class="col-sm-8">
		                  <input type="text" id="payAmount" class="form-control inputNotNull" maxlength="10" name="payAmount" /><span style="color: red;" id="payAmountError"></span>
		                </div>
		              </div> 
		              <div class="form-group">
		                <label  class="col-sm-2 control-label">商品市场价</label>
		                <div class="col-sm-8">
		                  <input type="text" id="marketAmount" class="form-control inputNotNull" maxlength="10" name="marketAmount" /><span style="color: red;" id="marketAmountError"></span>
		                </div>
		              </div> 
		             <div class="form-group"> 
		              ...
		              <div class="form-group">
		                ...
		                <div class="col-sm-8">
		                  <textarea type="text" id="goodsDescribe" class="form-control inputNotNull" maxlength="500" name="goodsDescribe" rows="2"></textarea>
		                </div>
		              </div>  
		              <div class="form-group">
		                <label  class="col-sm-2 control-label">注意事项</label>
		                <div class="col-sm-8">
		                  <textarea type="text" id="attentionMatters" class="form-control" maxlength="250" name="attentionMatters" rows="2"></textarea>    
		                </div> 
		              </div> 
		              <div class="form-group">
		                <label  class="col-sm-2 control-label">兑换流程</label>
		                <div class="col-sm-8">
		                  <textarea type="text" id="exchangeProcess" class="form-control" maxlength="250" name="exchangeProcess" rows="2"></textarea>
		                </div>
		              </div> 
		              <div class="row">
		                <div class="col-sm-6 text-right">
		                  <button type="button" onclick="subAddIntegralMall();" class="btn btn-primary">确定</button>
		                </div>
