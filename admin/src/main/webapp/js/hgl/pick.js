		...
		/*添加到收藏 --横向*/
		function addToSaveInfo(productId){
			$.ajax({
				type:"post",
				url:"doAddSaveInfo",
				data:{"id":productId},
				success:function(data){
					...
					if(data=="true"){
						showModifyTips("收藏成功");
						productSaveId.innerHTML="&#xe609;";
						productSaveId.title="已收藏";
					}else if(data=="false"){
						showModifyTips("收藏失败");
					}else if(data=="-1"){
						showModifyTips("该产品已经被收藏");					
						productSaveId.innerHTML="&#xe609;";
						productSaveId.title="已收藏";
					}
				}
		...
		/*添加到收藏 --纵向*/
		function addProductToSaveInfo(productId){
			$.ajax({
				type:"post",
				url:"doAddSaveInfo",
				data:{"id":productId},
				success:function(data){
					var	productSaveId =document.getElementById("productSaveId"+productId);
					if(data=="true"){
						showModifyTips("收藏成功");
						productSaveId.innerHTML="&#xe609;";
						productSaveId.title="已收藏";
		...
		/*产品收藏 ---招商*/
		function addMerchantsShopInfoSave(brandId){
			$.ajax({
				type:"post",
				url:"doAddSaveInfo",
