...
function dTree(objName, iPath, formId) {
	...
	this.icon = {
		root				: iPath+'/styles/images/dtree/base.gif',
		folder			: iPath+'/styles/images/dtree/folder.gif',
		folderOpen	: iPath+'/styles/images/dtree/folderopen.gif',
		node				: iPath+'/styles/images/dtree/page.gif',
		empty				: iPath+'/styles/images/dtree/empty.gif',
		line				: iPath+'/styles/images/dtree/line.gif',
		join				: iPath+'/styles/images/dtree/join.gif',
		joinBottom	: iPath+'/styles/images/dtree/joinbottom.gif',
		plus				: iPath+'/styles/images/dtree/plus.gif',
		plusBottom	: iPath+'/styles/images/dtree/plusbottom.gif',
		minus				: iPath+'/styles/images/dtree/minus.gif',
		minusBottom	: iPath+'/styles/images/dtree/minusbottom.gif',
		nlPlus			: iPath+'/styles/images/dtree/nolines_plus.gif',
		nlMinus			: iPath+'/styles/images/dtree/nolines_minus.gif'
	};
	this.parEnum = "";
	this.obj = objName;
	this.aNodes = [];
...
dTree.prototype.node = function(node, nodeId) {
	...
	//for leaves got the same font style with nodes modified by Nick.Peng start
	else 
		str += '<span class="node">';
	//for leaves got the same font style with nodes modified by Nick.Peng end	
	str += node.name;
