...
<!--文件上传 -->
	...
	<script src="${ctx}/js/hgl/customerService.js"></script> 
             ...
             <form id="key_${modalName}_qryFrm" class="form-horizontal">
              ...
              <div class="col-sm-12">
                <div id="key_${modalName}_list">
               		<%@include file="customerServiceList.jsp"%>
               </div>
              </div>
    		</div>
    		</div>
