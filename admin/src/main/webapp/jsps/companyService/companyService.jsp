    	      ...
    	      <div class="box-body">
                  <form class="form-horizontal" id="key_${modalName}_qryFrm">
		             <div class="row">
		              ...
		              <div class="col-sm-2 ">
		                     <input type="button" value="查询" class="btn btn-primary btn-sm" onclick="submitform()"></input>
		                	<c:if test="${fn:length(tbCompanyTypeList) > 0}">
		                      <input type="button" value="添加" class="btn btn-primary btn-sm" onclick="showAddpage()"></input>
		               	 	</c:if>
		                </div>
