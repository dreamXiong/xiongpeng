...
<head>
	<meta charset="UTF-8">
	<c:set value="支付订单" var="titleName"></c:set>
...
<div class="container">
	<div class="pay">
			...
			<div style="margin-top:5px;">
				<ul>
					<li class="clearfix">
						...
						<span class="pull-right">${wapOrderGroup.orderSerialNo}</span>
						<input type="hidden" value="${wapOrderGroup.id}" id="orderId"  />
						<input type="hidden" value="${wapOrderGroup.version}" id="version"  />
						<input type="hidden" value="${wapOrderGroup.orderStatus}" id="orderState"  />
					</li>
					<li class="clearfix">
						...
						<span class="pull-right">
							<div class="text-red font-bold">
								...
								<span class="unit">${wapOrderGroup.payMoney }</span>   
							</div>
						</span>
					</li>
					<li class="clearfix">
		...
		<c:if test="${wapOrderGroup.settleType != 240 || wapOrderGroup.orderStatus != 602}">
			<div class="submit-success clearfix box" style="margin-top:10px;">
				<a class="box1" href="${ctx }/">回到首页</a>	
				<a class="box1" href="${ctx }/wapOrderGroup/selectOrderGroup">我的订单</a>
			</div>	
		</c:if>
		<c:if test="${wapOrderGroup.settleType == 240 && wapOrderGroup.orderStatus == 602}">
			<h2>选择支付方式</h2>
			<div class="box-shadow info list">
					...
					<c:if test="${wapOrderGroup.payMoney < money }">
						<label>
