	...
	<ul class="nav">
		<li>
			<%-- <c:if test="${session_key.typeId == 114}">
				<a href="${ctx}/indexShopInfo"><span class="icon-home"></span> 首页</a>
			</c:if>
			<c:if test="${session_key.typeId != 114}">
		...
		<li><a href="${ctx}/pick/pickList"><span class="icon-shopping-cart"></span> 买材料</a></li>
		<li><a href="${ctx}/personalCenter/index"><span class="icon-user"></span> 我的</a></li>
	</ul> 
</header>
